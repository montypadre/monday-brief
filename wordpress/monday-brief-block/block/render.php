...
?>
<section <?php echo get_block_wrapper_attributes( array( 'class' => 'monday-brief' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> aria-labelledby="monday-brief-heading">
    <h2 id="monday-brief-heading" class="monday-brief__heading"><?php esc_html_e( 'This week', 'monday-brief-block' ); ?></h2>
